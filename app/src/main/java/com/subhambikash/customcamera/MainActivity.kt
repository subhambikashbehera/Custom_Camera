package com.subhambikash.customcamera
...
import com.subhambikash.customcamera.databinding.ActivityMainBinding
import java.io.File
                            ...
                            val thread = object : Thread() {
                                override fun run() {
                                    ...
                                    try {
                                        ...
                                        outputDir.mkdir()
                                        val mTranscodeOutputFile = File.createTempFile("transcode_test", ".mp4", outputDir)
                                        ...
                                        VideoCompressor.start(
                                            ...
                                            uris = listOf(recordEvent.outputResults.outputUri), // => Source can be provided as content uris
                                            isStreamable = true,
                                            ...
                                            configureWith = Configuration(
                                                ...
                                                videoWidth = 480.0, /*Double, ignore, or null*/
                                                videoHeight = 360.0 /*Double, ignore, or null*/
                                            ...
                                            listener = object : CompressionListener {
                                                override fun onProgress(index: Int, percent: Float) {
                                                    ...
                                                    Log.d("pathVideo", "onSuccess: $index")
                                                }
                                                ...
                                                override fun onSuccess(index: Int, size: Long, path: String?) {
                                                    Log.d("pathVideo", "onSuccess: $path")
                                                }

                                                override fun onFailure(index: Int, failureMessage: String) {
                                                    Log.d("pathVideo", "onSuccess: $failureMessage")
                                                }
